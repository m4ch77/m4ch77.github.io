...
//
//  주석을 // 로 쓰는 이유가 있습니다. 이 파일은 cron 식을 자주 적게
//  되는데, 블록 주석 안에 별표와 슬래시가 붙은 형태가 들어가면 그
//  자리에서 주석이 닫혀 버립니다. 실제로 그것 때문에 배포가 한 번
//  실패했습니다 (Unexpected "*"). 줄 주석에는 그 함정이 없습니다.
//
//  왜 이걸 따로 두는가
//    GitHub 의 schedule 은 보장이 아니라 최선 노력입니다. 5분 간격으로
//    두었는데 실제로는 2~2.7시간에 한 번 돌았습니다. 실측한 스케줄 실행
//    시각(UTC)이 05:35 · 08:06 · 10:48 · 12:50 였습니다. 87번 돌아야 할
//    자리에 3번 돌았습니다. cron 문법으로 고칠 수 있는 문제가 아닙니다.
//
...
//
//  올리기 — cron/ 폴더에서
//    npx wrangler secret put GH_TOKEN   ← 붙여넣기 (채팅에 남기지 마세요)
//    npx wrangler deploy
//
//  손으로 한 번 돌려 보기 — 자세한 명령은 cron/README.md 에 있습니다
